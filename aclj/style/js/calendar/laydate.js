 ...
 */
;
if($('#laydate_box').size()>0)$('#laydate_box').remove();
! function (a) {
    ...
    var b = {
        ...
        h = ["laydate_box", "laydate_void", "laydate_click", "LayDateSkin", "calendar/skins/", "/laydate.css"];
    ...
    a.laydate = function (b) {
        ...
        c.use("calendar/need"), c.use(h[4] + b.defSkin, h[3]), c.skinLink = c.query("#" + h[3])
