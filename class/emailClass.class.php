<?php
class emailClass extends smtp{
    function __construct(){
    }
    private function my_mail($smtpserver,$smtpserverport,$smtpusermail,$smtpemailto,$smtpuser,$smtppass,$mailsubject,$mailbody,$mailtype){
	...
	//发送邮件，需要目标邮箱和内容，主题
	public function send($to,$tit,$info){
        return $this->my_mail('smtp.126.com',25,'lj_f123@126.com',$to,'lj_f123@126.com','s123456',$tit,$info,'HTML');
	}
}
