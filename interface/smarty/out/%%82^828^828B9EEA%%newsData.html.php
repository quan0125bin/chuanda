<?php /* Smarty version 2.6.18, created on 2017-08-02 09:04:19
         compiled from newsData.html */ ?>
...
?>
<li data-animated="fadeInUp"><a href="<?php echo $this->_tpl_vars['data'][$this->_sections['d']['index']]['url']; ?>
">
    <div class="time">
         <h3><?php echo $this->_tpl_vars['data'][$this->_sections['d']['index']]['_time_y']; ?>
</h3>
        <h2><?php echo $this->_tpl_vars['data'][$this->_sections['d']['index']]['_time_md_']; ?>
</h2>
    </div>
    <h4><?php echo $this->_tpl_vars['data'][$this->_sections['d']['index']]['names']; ?>
</h4>
    <h5><?php echo $this->_tpl_vars['data'][$this->_sections['d']['index']]['conts']; ?>
</h5>
</a></li>
<?php endfor; endif; ?>